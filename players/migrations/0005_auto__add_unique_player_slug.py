...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Player', fields ['slug']
        db.create_unique(u'players_player', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Player', fields ['slug']
        db.delete_unique(u'players_player', ['slug'])
