...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GamePlayerRating'
        db.create_table(u'ratings_gameplayerrating', (
        ...
        db.send_create_signal(u'ratings', ['GamePlayerRating'])

        # Adding unique constraint on 'GamePlayerRating', fields ['player', 'game']
        db.create_unique(u'ratings_gameplayerrating', ['player_id', 'game_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'GamePlayerRating', fields ['player', 'game']
        db.delete_unique(u'ratings_gameplayerrating', ['player_id', 'game_id'])

        # Deleting model 'GamePlayerRating'
        db.delete_table(u'ratings_gameplayerrating')
    ...
    models = {
        ...
        u'ratings.gameplayerrating': {
            'Meta': {'unique_together': "(('player', 'game'),)", 'object_name': 'GamePlayerRating'},
            'game': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['games.Game']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['players.Player']"}),
