...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GamePlay.played_at'
        db.add_column(u'games_gameplay', 'played_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GamePlay.played_at'
        db.delete_column(u'games_gameplay', 'played_at')
    ...
    models = {
        ...
        u'games.gameplay': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'played_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
