...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GamePlay.played_at'
        db.alter_column(u'games_gameplay', 'played_at', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'GamePlay.played_at'
        db.alter_column(u'games_gameplay', 'played_at', self.gf('django.db.models.fields.DateField')())
