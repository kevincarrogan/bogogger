...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Game', fields ['slug']
        db.create_unique(u'games_game', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Game', fields ['slug']
        db.delete_unique(u'games_game', ['slug'])
