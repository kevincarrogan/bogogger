...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'groups_playergroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from='name')),
        ))
        db.send_create_signal(u'groups', ['PlayerGroup'])

        # Adding M2M table for field players on 'PlayerGroup'
        m2m_table_name = db.shorten_name(u'groups_playergroup_players')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('playergroup', models.ForeignKey(orm[u'groups.playergroup'], null=False)),
        ...
        m2m_table_name = db.shorten_name(u'groups_playergroup_games')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('playergroup', models.ForeignKey(orm[u'groups.playergroup'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'groups_playergroup')

        # Removing M2M table for field players on 'PlayerGroup'
        db.delete_table(db.shorten_name(u'groups_playergroup_players'))

        # Removing M2M table for field games on 'PlayerGroup'
        db.delete_table(db.shorten_name(u'groups_playergroup_games'))
