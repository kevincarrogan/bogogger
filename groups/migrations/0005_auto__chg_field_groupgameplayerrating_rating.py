...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GroupGamePlayerRating.rating'
        db.alter_column(u'groups_groupgameplayerrating', 'rating_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['groups.GroupRating']))

    def backwards(self, orm):

        # Changing field 'GroupGamePlayerRating.rating'
        db.alter_column(u'groups_groupgameplayerrating', 'rating_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ratings.Rating']))
