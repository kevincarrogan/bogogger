...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GroupRating'
        db.create_table(u'groups_grouprating', (
        ...
        db.send_create_signal(u'groups', ['GroupRating'])


    def backwards(self, orm):
        # Deleting model 'GroupRating'
        db.delete_table(u'groups_grouprating')
